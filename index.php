...
?><?
require($_SERVER["DOCUMENT_ROOT"] . "/webmin/header.php");
$APPLICATION->SetTitle("APKA - tìm xe đưa đón sân bay giá tốt");
?>
    <script>
        function initMap() {
                ...
                <div class="carousel-inner">
                    <div style="background: url(&quot;http://apka.vn/webmin/templates/main/images/bapka.jpg&quot;);"
                        ...
                        <div class="carousel-caption">
                            <h1>Thoải m&aacute;i như xe nh&agrave;. Giá rẻ như xe khách</h1>
                        </div>
                    </div>
                </div>
...
//                    "PROPERTY_CODE" => array('HOP_SO','GIA'),
//                    "CHECK_DATES" => "Y",
//                    "DETAIL_URL" => "",
//                    "PREVIEW_TRUNCATE_LEN" => "",
...
//                    "AJAX_OPTION_STYLE" => "N",
//                    "AJAX_OPTION_HISTORY" => "N",
//                    "TITLE_BAR" => "Chọn chiếc xe mơ ước",
//                    "SHOW_MORE" => "Y",
