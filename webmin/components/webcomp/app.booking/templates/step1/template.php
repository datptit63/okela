...
<div class="">
    <div class="">
        <div class="">
            ...
            <div id="map"></div>
            <div id="form_input"
                 style="margin-bottom: 10px;padding:10px;background: #f5f5f5;border-radius: 5px;border:1px solid #DDD">
                ...
                <form id="frmDatXe" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col pick-group padding_top">
                            <div class="input-group append_pick_address_here"><span class="input-group-addon"><i
                                            class="fa fa-map-marker mpick" style="color: #3c8dbc"
                                            aria-hidden="true"></i> </span> <select name="data[pick_address_raw]"
                                                                                    id="data_pick_address_raw"
                                                                                    class="MyCombobox select2 form-control"
                                                                                    style="display: none;"
                                                                                    placeholder="Điểm đ&oacute;n, sân bay hoặc khách sạn"></select><span
                                        class="custom-combobox"><span role="status" aria-live="polite"
                                                                      class="ui-helper-hidden-accessible"></span><input
                                            style="outline: none" required="" title=""
                                            ...
                                            value="<?= $_REQUEST["depart_pick"] ?>" name="depart_pick"
                                            placeholder="Điểm đón"/><span onclick="$('#searchInputGo').val('')"
                                                                          id="coner_right_mpick"
                                                                          class="coner-right-container"
                                                                          style="background: none 0% 0% / auto repeat scroll padding-box border-box rgb(255, 255, 255);"><i
                                                class="ui-corner-right fa fa-remove my-location"></i><span
                        ...
                        <div class="col-md-12 col drop-group padding_top homepage-input-search-container">
                            <div class="input-group append_drop_address_here"><span class="input-group-addon"><i
                                            class="fa fa-map-marker mdrop" aria-hidden="true"></i></span> <select
                                        name="" id="data_drop_address_raw" class="MyCombobox select2 form-control"
                                        style="display: none;"
                                        ...
                                        class="custom-combobox"><span role="status" aria-live="polite"
                                            ...
                                            style="outline: none" required="" title=""
                                            class="custom-combobox-input ui-widget ui-widget-content ui-state-default ui-corner-left ui-autocomplete-input"
                                            autocomplete="off" data-original-title="" id="searchInputTo"
                                            value="<?= $_REQUEST["depart_drop"] ?>" name="depart_drop"
                                            placeholder="Điểm đến"/><span id="coner_right_mdrop"
                                                                          onclick="$('#searchInputTo').val('')"
                                                                          class="coner-right-container"
                                                                          style="background: none 0% 0% / auto repeat scroll padding-box border-box rgb(255, 255, 255);"><i
                                                class="ui-corner-right fa fa-remove my-location"></i><span
                                                class="ui-corner-right reset_selected hide">×</span></span></span></div>
                        </div>
                        <div class="col-md-12 col drop-group padding_top homepage-input-search-container">
                            <div class="input-group append_drop_address_here"><span class="input-group-addon"><i
                                            class="fa fa-calendar mdrop" style="font-size: 9px" aria-hidden="true"></i></span>
                                <select name="" id="data_drop_address_raw" class="MyCombobox select2 form-control"
                                        style="display: none;"
                                        placeholder="Điểm đến, sân bay hoặc khách sạn"></select><span
                                        class="custom-combobox"><span role="status" aria-live="polite"
                                                                      class="ui-helper-hidden-accessible"></span><input
                                            style="outline: none" required="" title=""
                                            class="datepicker custom-combobox-input ui-widget ui-widget-content ui-state-default ui-corner-left ui-autocomplete-input"
                                            autocomplete="off" data-original-title=""
                                            value="<?= $_REQUEST["depart_time"] ?>" placeholder="Thời gian đón"
                                            name="depart_time"/></span></div>
                        </div>

                        <div class="col-md-12 col drop-group padding_top">
                            <button type="submit" class="btn btn_blue" id="show_cost"><i class="fa fa-search"></i> TÌM
                                XE
                            </button>
                            <input type="hidden" id="depart_pick_pos" value="<?= $_REQUEST['depart_pick_pos'] ?>"
                                   name="depart_pick_pos">
                            <input type="hidden" id="depart_drop_pos" value="<?= $_REQUEST['depart_drop_pos'] ?>"
                                   name="depart_drop_pos">

                            <input type="hidden" id="book_type" value="<?= $_REQUEST['book_type'] ?>" name="book_type">
                            <input type="hidden" value="<?= $_REQUEST["depart_time"] ?>" id="searchTime"
                                   name="searchTime">
                            ...
                            <input type="hidden" id="customerID" name="customerID"
                                   value="<?= intval($GLOBALS["USER"]->GetID()) ?>">
                            <input type="hidden" id="customerName" name="customerName"
                                   value="<?= ($GLOBALS["USER"]->GetID() > 0 ? $GLOBALS["USER"]->GetFullName() : "_Chưa xác định_") ?>">
                            <input type="hidden" id="customerPhone" name="customerPhone"
                                   value="<?= ($GLOBALS["USER"]->GetID() > 0 ? $GLOBALS["USER"]->GetLogin() : "_Chưa xác định_") ?>">
                        </div>
                        <div class="col-md-12 col drop-group padding_top"
                             style="text-align: center;font-style: italic;color: #444444;font-size: 13px">
            ...
            <div class="modal fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="loading_price_container">
                    ...
                    <p class="loading_text">Hệ thống đang đấu giá - tìm giá tốt nhất..</p>
                </div>
            </div>
...
//                                                    pushToBidding();
                        ...
                        setInterval(function () {
                            bidding();
                        }, <?=$arDataXe->CONFIG->PROPERTY_SECOND_CALL_DAU_GIA_VALUE * 1000?>);
        ...
        <div id="result_search">
            ...
            $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "IBLOCK_ID" => 14,
                    "NEWS_COUNT" => "10",
                    "SORT_BY1" => "PROPERTY_LOAI_XE",
                    "SORT_ORDER1" => "ASC",
                    "SORT_BY2" => "PROPERTY_GOI_XE",
                    "SORT_ORDER2" => "ASC",
                    "FILTER_NAME" => "",
                    "FIELD_CODE" => array(),
                    "PROPERTY_CODE" => array('LOAI_XE'),
                    "CHECK_DATES" => "Y",
                    "DETAIL_URL" => "",
...
<div id="result_update" style="position: fixed;bottom:0px;height: 50px;left: -5px;right:-5px;display: none">
    ...
    <div class="alert alert-success alert-dismissible">
        ...
        <div style="text-align: center"><strong><a href="javascript:void(0)" style="color: #fff;text-decoration: none"
                                                   onclick="refreshGrid_()"> <i class="fa fa-refresh"></i> Làm mới dữ
                    liệu</a></strong>
        </div>
    </div>
</div>
