                        ...
                        <div class="tabbable">
                            <div class="tab-content">
                                <div id="pane1" class="tab-pane active">
                                        ...
                                        <h3 style="text-align: center;">THÔNG TIN ĐẶT XE</h3>
                                    </div>
                                        ...
                                        <div class="col-md-12 padding_top">
                                            ...
                                            <div class="col-md-8 col-sm-8 padding_top ride_date_time">
                                                <input autocomplete="off" type="text" class="datxe_form-control form_datetime" required
                                        ...
                                        <div class="col-md-8 col-sm-8 padding_top ride_date_time">
                                            <input id="ma_khuyen_mai"
                                                   value="<?= $_REQUEST['ma_khuyen_mai'] ?>"
                                                   name="ma_khuyen_mai" class="datxe_form-control">
                                        </div>
                                    </div>
                                         <input type="hidden" id="ma_khuyen_mai" value="<?= $_REQUEST['ma_khuyen_mai'] ?>" name="ma_khuyen_mai">


                                    <!--Hidden Input loai xe-->
                                        <div class="col-md-12 padding_top" hidden >
                                            <div class="col-md-4 col-sm-4 padding_top">
